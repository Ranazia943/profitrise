   ...
   <div>
     ...
     <div id="sidebar-wrapper" className={`${side ? "open":""}`}>
      ...
      <div className="dashboard-side min-h-screen ">
       ...
       <h2 className="text-2xl font-extrabold bg-gradient-to-tr from-cyan-300 via-cyan-100 inline-block px-16 rounded-full text-gray-600 py-4">Update user</h2>
       </div>
        <div className="form mt-20">
        <div className="p-4 mx-auto max-w-xl bg-white font-[sans-serif]">
  <form className="mt-8 space-y-4">
    <input type="text" placeholder="Name" value={"Rana Zia"} className="w-full rounded-md py-3 px-4 text-gray-800 bg-gray-100 focus:bg-transparent text-sm outline-blue-500" />
    <input type="email" placeholder="Email" value={"zia@gmail.com"} className="w-full rounded-md py-3 px-4 text-gray-800 bg-gray-100 focus:bg-transparent text-sm outline-blue-500" />
    <select name="" id="" className=' w-full h-10 border outline-none'>
