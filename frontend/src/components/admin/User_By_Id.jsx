   ...
   <div>
     ...
     <div id="sidebar-wrapper" className={`${side ? "open":""}`}>
      ...
      <div className="dashboard-side min-h-screen ">
       ...
       <h2 className="text-2xl font-extrabold bg-gradient-to-tr from-cyan-300 via-cyan-100 inline-block px-16 rounded-full text-gray-600 py-4">User Detail</h2>
       </div>
       <div className="wrapper flex justify-center my-10 items-center min-h-[80vh]">
        <div className="card">
 <div className="bg-white overflow-hidden shadow rounded-lg border">
  <div className="px-4 py-5 sm:px-6">
   <img src="/images/profile.png" className=' w-20 h-20 m-auto my-4' alt="" />
